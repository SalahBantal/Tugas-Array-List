...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // seed
        students.add(new Student("20200040148", "Muhammad"));
        students.add(new Student("20200040148", "Akbar"));
        books.add(new Book("1", "Laskar Pelangi"));
        books.add(new Book("2", "Riyadhus Shalihin"));
